...
@adobe/aio-cli-plugin-telemetry/0.2.2 darwin-x64 node-v14.19.0
$ aio --help [COMMAND]
USAGE
  $ aio COMMAND
...
...
_See code: [src/commands/telemetry/index.js](https://github.com/adobe/aio-cli-plugin-telemetry/blob/v0.2.2/src/commands/telemetry/index.js)_
<!-- commandsstop -->
