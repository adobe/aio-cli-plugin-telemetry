...
@adobe/aio-cli-plugin-telemetry/0.3.0 darwin-x64 node-v14.19.0
$ aio --help [COMMAND]
USAGE
  $ aio COMMAND
...
...
_See code: [src/commands/telemetry/index.js](https://github.com/adobe/aio-cli-plugin-telemetry/blob/v0.3.0/src/commands/telemetry/index.js)_
<!-- commandsstop -->
